...
pkl_file = open('features/' + dataset_name + '_sequence_data.pkl', 'wb')
pickle.dump(sequence_data_list, pkl_file)
pkl_file.close()
pkl_file = open('features/' + dataset_name + '_label.pkl', 'wb')
pickle.dump(faked_label_list, pkl_file)
pkl_file.close()
pkl_file = open('features/' + dataset_name + '_pssm_data.pkl', 'wb')
pickle.dump(pssm_data_list, pkl_file)
pkl_file.close()
pkl_file = open('features/' + dataset_name + '_netsurf_ss_14_standard.pkl', 'wb')
pickle.dump(protein_netsurf_list, pkl_file)
pkl_file.close()
pkl_file = open('features/' + dataset_name + '_MSA_features_1.pkl', 'wb')
...
pkl_file.close()
pkl_file = open('features/' + dataset_name + '_list.pkl', 'wb')
pickle.dump(dset_list, pkl_file)
pkl_file.close()

make_prediction('model_for_prediction.pth', [dataset_name], 0.5, dataset_name)
